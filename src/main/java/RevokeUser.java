...
public class RevokeUser {
    ...
    public static void main(String args[]) throws Exception{
        ...
        startedWithRevokes = RevokeUser.getRevokes(null).length; //one more after we do this revoke.
...
//        assertNotNull("Failed to get CRL using the Revoke API", crl);
        ...
        final int newRevokes = RevokeUser.getRevokes(null).length;

        System.out.println(newRevokes);

        TBSCertList.CRLEntry crlEntries [] = RevokeUser.getRevokes(null);
